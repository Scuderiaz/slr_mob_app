...
export default function ReceiptModal() {
  ...
  const handleDownload = async () => {
    Alert.alert(
      ...
      'Save PDF receipt to your device?',
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              const fileName = `Water_Bill_Receipt_${timestamp}.pdf`;
              
              // Share PDF - works in Expo Go!
              if (await Sharing.isAvailableAsync()) {
                ...
                Alert.alert('PDF Generated', `Receipt created as: ${fileName}`);
              }
            } catch (error) {
              console.error('PDF Save Error:', error);
              Alert.alert(
                'Save Failed', 
                'Unable to save PDF to device. Please try again.',
                [{ text: 'OK' }]
              );
            }
          }
